...
nzRound:AddZombieType("Tranzit SuperSprinters", "nz_zombie_walker_tranzit_supersprint", {
...
ENT.SequenceTables = {
	...
	{Threshold = 155, Sequences = { -- How to defeat nZC players in one simple step! Add Supersprinters!
		{
