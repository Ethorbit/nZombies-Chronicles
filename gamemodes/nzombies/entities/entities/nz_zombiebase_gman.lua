-- READ:
-- this is NOT a replacement for nz_zombiebase!!
-- if this is going to be used, please see moo base's implementation to see how it exists without having to override fucking everything
-- zombiebase has had a lot of time dumped into it to ensure it's stable and bug-free, this is why it's important we do not override it!
-- Thanks.

-- "addons\\nzombies\\gamemodes\\nzombies\\entities\\entities\\nz_zombiebase.lua"
...
function ENT:Jump()
	...
	if !navarea or navarea:HasAttributes(NAV_MESH_NO_JUMP) then return end
